...
class StoreUpdateHip_Knee extends FormRequest
{
    /**
    ...
    public function rules()
    {
        return [
            ...
            'right_knee_flexion' => ['required','numeric'],
            'left_knee_flexion' => ['required','numeric'],
            'right_knee_extension' => ['required','numeric'],
            'left_knee_extension' => ['required','numeric'],
