...
<!-- abas -->
<div class="col-md-12">
    <ul id="profileTabs" class="nav nav-tabs mb-4 border-bottom border-dark bg-dark">
        <li class="active" ><a href="#pills-geral" data-toggle="tab" class="nav-link">Geral</a></li>
        <li><a href="#pills-historic_pregress" data-toggle="tab" class="nav-link">Histórico Pregresso</a></li>
        <li><a href="#pills-redflags" data-toggle="tab" class="nav-link">Redflags</a></li>
        <li><a href="#pills-historic" data-toggle="tab" class="nav-link">Histórico</a></li>
        <li><a href="#pills-subjective" data-toggle="tab" class="nav-link">Subjetiva</a></li>
        <li><a href="#pills-objective" data-toggle="tab" class="nav-link">Objetiva</a></li>
        <li><a href="#pills-questionnaires" data-toggle="tab" class="nav-link">Questionários</a></li>
        <li><a href="#pills-exams" data-toggle="tab" class="nav-link">Exames</a></li>
    ...
    <div class="tab-content" id="pills-tabContent">
        <!-- geral -->
        <div class="tab-pane fade show active" id="pills-geral" role="tabpanel" aria-labelledby="pills-home-tab">
        ...
        <!-- historic_pregress -->
        <div class="tab-pane fade" id="pills-historic_pregress" role="tabpanel" aria-labelledby="pills-historic_pregress-tab">
            @if($past == "false")
        ...
        <!-- redflags -->
        <div class="tab-pane fade" id="pills-redflags" role="tabpanel" aria-labelledby="pills-profile-tab">
            @if($redflag == "false")    
        ...
        <!-- subjective -->
        <div class="tab-pane fade" id="pills-subjective" role="tabpanel" aria-labelledby="pills-subjective-tab">
        @if($subjective == "false")
        ...
        <!-- questionnaires -->
        <div class="tab-pane fade" id="pills-questionnaires" role="tabpanel" aria-labelledby="pills-questionnaires-tab">  
           <br>
            ...
            <table class="table" id="info">
                <tbody>
                    <tr>
                        ...
                        <td><a href="/csi_questionnaire/{{$questionnaire['id']}}" class="btn" data-toggle="tooltip" data-placement="top" title="CSI"><ion-icon name="document-text"></ion-icon></a></td>
                        <td></td>
                    </tr>
                    <tr>
                        <td>2</td>
                        <td>Questionário: Escala de pensamento catastrófico sobre a dor -B-PCS</td>
                        <td><a href="/bpcs_questionnaire/{{$questionnaire['id']}}" class="btn" data-toggle="tooltip" data-placement="top" title="CSI"><ion-icon name="document-text"></ion-icon></a></td>
                        <td></td>
                    </tr>
                    <tr>
                        <td>3</td>
                        <td>Questionário: Escala de autoeficácia para dor</td>
                        <td><a href="/aedc_questionnaire/{{$questionnaire['id']}}" class="btn" data-toggle="tooltip" data-placement="top" title="ADEC"><ion-icon name="document-text"></ion-icon></a></td>
                        <td></td>
                    </tr>
                    <tr>
                        <td>4</td>
                        <td>Questionário: Crenças para evitar o medo - FABQ</td>
                        <td><a href="/fabq_questionnaire/{{$questionnaire['id']}}" class="btn" data-toggle="tooltip" data-placement="top" title="CSI"><ion-icon name="document-text"></ion-icon></a></td>
                        <td></td>
                    </tr>
                    <tr>
                        <td>5</td>
                        <td>Questionário: Escala tampa de Cinesofobia</td>
                        <td><a href="/etc_questionnaire/{{$questionnaire['id']}}" class="btn" data-toggle="tooltip" data-placement="top" title="CSI"><ion-icon name="document-text"></ion-icon></a></td>
                        <td></td>
                    </tr>
        ...
        <!-- exams -->
        <div class="tab-pane fade" id="pills-exams" role="tabpanel" aria-labelledby="pills-contact-tab">
