...
<section class="section dashboard">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <ul class="nav nav-tabs d-flex" id="myTabjustified" role="tablist">
                        ...
                        <li class="nav-item flex-fill" role="presentation">
                            <button class="nav-link w-100 active" id="hip_Knee-tab" data-bs-toggle="tab" data-bs-target="#hip_knee-justified" type="button" role="tab" aria-controls="hip_Knee" aria-selected="true">Quadril/Joelho</button>
                        </li>
                        <li class="nav-item flex-fill" role="presentation">
                            <button class="nav-link w-100 active" id="elbow_fist-tab" data-bs-toggle="tab" data-bs-target="#elbow_fist-justified" type="button" role="tab" aria-controls="elbow_fist" aria-selected="true">Cotovelo/Punho</button>
                        </li>
                        <li class="nav-item flex-fill" role="presentation">
                            <button class="nav-link w-100 active" id="ankle-tab" data-bs-toggle="tab" data-bs-target="#ankle-justified" type="button" role="tab" aria-controls="ankle" aria-selected="true">Tornozelo</button>
                        </li>
                    </ul>
    ...
    <div class="col-md-12" id="info">
        ...
        <ul id="profileTabs" class="nav nav-tabs mb-4 border-bottom border-dark bg-dark">
                <li class="active" ><a href="#pills-shoulder" data-toggle="tab" class="nav-link">Ombro</a></li>
                <li><a href="#pills-hip" data-toggle="tab" class="nav-link">Quadril/Joelho</a></li>
                <li><a href="#pills-elbow_fist" data-toggle="tab" class="nav-link">Cotovelo/Punho</a></li>
                <li><a href="#pills-ankle" data-toggle="tab" class="nav-link">Tornozelo</a></li>
       </ul>
