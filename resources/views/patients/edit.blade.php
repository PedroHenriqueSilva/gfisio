            ...
            <div class="row">
                ...
                <div class="col-md-3">    
                    <div class="form-group">
                        ...
                        <input type="date" class="form-control" id="date_nasc" name="date_nasc" value="{{ $patient->date_nasc }}" >
                    </div>
                </div>
                <div class="col-md-2">    
                    <div class="form-group">
            ...
            <div class="row">
                <div class="col-md-4">        
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="end" name="end" value="{{ $patient->end }}">
                    </div>
                </div>    
                <div class="col-md-2">    
                    <div class="form-group">
                        <label for="title">Estado:</label>
                        <input type="text" class="form-control" id="state" name="state" value="{{ $patient->state }}" >
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="form-group">
                        <label for="title">Cidade:</label>
                        <input type="city" class="form-control" name="city" id="city" value="{{ $patient->city }}" >
                    </div>
                </div> 
            ...
            <div class="row">
                <div class="col-md-4">        
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="profission" name="profission" value="{{ $patient->profission }}" >
                    </div>
                </div>    
                <div class="col-md-2">
                    <div class="form-group">
                        <label for="title">Estado Civil:</label>
                        <input type="text" class="form-control" id="civil_status" name="civil_status" value="{{ $patient->civil_status }}" >
                    </div>
                </div>    
                <div class="col-md-1">
                    <div class="form-group">
                        <label for="title">Filhos:</label>
                        <input type="text" class="form-control" id="sons" name="sons" value="{{ $patient->sons }}" >
                    </div>
                </div> 
                <div class="col-md-2">
                    <div class="form-group">
